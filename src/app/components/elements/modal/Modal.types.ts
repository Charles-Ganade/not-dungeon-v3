...
export interface ModalProps
  extends Omit<JSX.HTMLAttributes<HTMLDialogElement>, "open" | "tabindex">,
    ModalPanelVariants {
  ...
  overlayProps?: Omit<JSX.HTMLAttributes<HTMLDivElement>, "class" | "onClick">;
