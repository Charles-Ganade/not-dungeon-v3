...
function hookApiCompletions(
  ...
  return {
    ...
    // This allows CM to continue looking for other completions
    // if this one isn't a perfect match (optional based on preference)
    filter: true,
  };
}
...
export function CodeEditor(props: CodeEditorProps) {
  ...
  let threadToKill: Worker | null = null; // Store the raw thread for cleanup
